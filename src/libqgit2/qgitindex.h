...
namespace LibQGit2
{
    ...
    class LIBQGIT2_EXPORT Index
    {
        public:
            ...
            enum AddFlag {
                AddDefault = GIT_INDEX_ADD_DEFAULT,
                AddForce = GIT_INDEX_ADD_FORCE,
                AddDisablePathspecMatch = GIT_INDEX_ADD_DISABLE_PATHSPEC_MATCH,
                AddCheckPathspec = GIT_INDEX_ADD_CHECK_PATHSPEC,
            };

            Q_DECLARE_FLAGS(AddFlags, AddFlag)

            void addAll(const QList<QString> &pathspecs = QList<QString>(), AddFlags flags = AddDefault);
            /**
            ...
            void removeAll(const QList<QString> &pathspecs = QList<QString>());
            /**
