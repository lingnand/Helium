...
#define yyparse         stylesc_parse
#define yylex           stylesc_lex
#define yyerror         stylesc_error
#define yylval          stylesc_lval
#define yychar          stylesc_char
#define yydebug         stylesc_debug
#define yynerrs         stylesc_nerrs


/* Copy the first part of user declarations.  */

/* Line 268 of yacc.c  */
#line 1 "../../../lib/srchilite/styleparser.yy"
...
static QMutex mut; // ugly mutex to make it work across different threads
...
/* Line 268 of yacc.c  */
#line 145 "../../../lib/srchilite/styleparser.cc"
...
/* Line 293 of yacc.c  */
#line 219 "../../../lib/srchilite/styleparser.cc"
} YYSTYPE;
...
/* Line 343 of yacc.c  */
#line 231 "../../../lib/srchilite/styleparser.cc"
...
{
       0,     0,     3,     4,     6,     9,    11,    13,    15,    16,
      23,    27,    29,    30,    32,    34,    35,    39,    43,    47,
      51,    52,    54,    58,    60,    62,    64,    66,    68,    70
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      19,     0,    -1,    -1,    20,    -1,    20,    21,    -1,    21,
      -1,    22,    -1,    27,    -1,    -1,    24,    25,    26,    23,
      28,    15,    -1,    24,    16,     9,    -1,     9,    -1,    -1,
      10,    -1,    12,    -1,    -1,    13,    17,    10,    -1,    13,
      17,    12,    -1,    14,    10,    15,    -1,    14,    12,    15,
      -1,    -1,    29,    -1,    29,    16,    30,    -1,    30,    -1,
       3,    -1,     4,    -1,     5,    -1,     6,    -1,     7,    -1,
       8,    -1
};
...
{
  "$end", "error", "$undefined", "BOLD", "ITALICS", "UNDERLINE", "FIXED",
  "NOTFIXED", "NOREF", "KEY", "COLOR", "BG_COLOR", "STRINGDEF", "BG_T",
  "BODY_BG_COLOR", "';'", "','", "':'", "$accept", "stylefile",
  "statements", "statement", "option", "$@1", "keylist", "color",
  "bgcolor", "bodybgcolor", "stylevalues", "values", "value", 0
};
#endif
...
{
       2,    11,     0,     0,     3,     5,     6,    12,     7,     0,
       0,     1,     4,    13,    14,     0,    15,    18,    19,    10,
       0,     8,     0,    20,    16,    17,    24,    25,    26,    27,
      28,    29,     0,    21,    23,     9,     0,    22
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     3,     4,     5,     6,    23,     7,    16,    21,     8,
      32,    33,    34
};
...
{
       5,   -14,    -9,    16,     5,   -14,   -14,   -10,   -14,   -11,
       2,   -14,   -14,   -14,   -14,    -4,     7,   -14,   -14,   -14,
       1,   -14,     3,     4,   -14,   -14,   -14,   -14,   -14,   -14,
     -14,   -14,     6,     8,   -14,   -14,     4,   -14
};
...
{
      13,     9,    14,    10,    17,    19,    15,    26,    27,    28,
      29,    30,    31,    24,     1,    25,    11,    18,    22,     2,
      20,    35,    12,    37,    36
};
...
{
      10,    10,    12,    12,    15,     9,    16,     3,     4,     5,
       6,     7,     8,    10,     9,    12,     0,    15,    17,    14,
      13,    15,     4,    36,    16
};
...
{
       0,     9,    14,    19,    20,    21,    22,    24,    27,    10,
      12,     0,    21,    10,    12,    16,    25,    15,    15,     9,
      13,    26,    17,    23,    10,    12,     3,     4,     5,     6,
       7,     8,    28,    29,    30,    15,    16,    30
};
...
/* Line 1391 of yacc.c  */
#line 1232 "../../../lib/srchilite/styleparser.cc"
	break;
      case 25: /* "color" */
...
/* Line 1391 of yacc.c  */
#line 1244 "../../../lib/srchilite/styleparser.cc"
	break;
      case 26: /* "bgcolor" */
...
/* Line 1391 of yacc.c  */
#line 1256 "../../../lib/srchilite/styleparser.cc"
	break;
...
#line 111 "../../../lib/srchilite/styleparser.yy"
    {
               ...
               StyleConstantsPtr stylevalues = StyleConstantsPtr((yyvsp[(5) - (6)].styleconstants));
               for (KeyList::const_iterator it = keylist->begin(); it != keylist->end(); ++it) {
                key = *it;
                if (!formatterFactory->createFormatter(key, ((yyvsp[(2) - (6)].string) ? *(yyvsp[(2) - (6)].string) : ""), ((yyvsp[(3) - (6)].string) ? *(yyvsp[(3) - (6)].string) : ""), stylevalues)) {
...
/* Line 1806 of yacc.c  */
#line 1758 "../../../lib/srchilite/styleparser.cc"
      default: break;
    }
